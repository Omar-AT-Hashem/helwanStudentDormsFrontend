                                ...
                                <div className="box" key={record.id }>
                                    <form className="flex flex-col  py-2 2xl:text-3xl text-2xl	pr-8	">
                                           ...
                                           <div className='mb-4'>
                                              ...
                                              <input type="text" className="border border-gray-400"></input>
                                            </div>
                                            ...
                                            <div>
                                             ...
                                             <input id="radio1" type="radio" name="radio-group" class="form-radio h-5 w-5 text-gray-600 mr-10" value="lunch"></input>
                                             <label>غداء</label>
                                             <input id="radio2" type="radio" name="radio-group" class="form-radio h-5 w-5 text-gray-600 mr-10" value="dinner"></input>
                                             <label>عشاء</label>
                                           </div>
                                             ...
                                             <div className='mb-2'>
                                              ...
                                              <button class="bg-blue-500 hover:opacity-70 hover:cursor-pointer transition-all duration-200  text-white font-bold py-2 px-4 rounded mx-2 w-20 mt-10 ">تعديل</button>
                                   ...
                                   <table className="table-auto w-4/5 mx-auto">
                                      <thead>
                                        <tr>
                                           ...
                                           <th className="px-4 py-2" >الوجبه<button class="bg-blue-500 hover:opacity-70 hover:cursor-pointer transition-all duration-200 text-white font-bold py-2 px-4 rounded mx-2 mr-10">اضافه</button></th>
                                        </tr>
                                      </thead>
                                      <tbody>
                                        <tr></tr>
