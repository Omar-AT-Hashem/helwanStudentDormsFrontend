    ...
    const data = {
      ...
      "وافد و جدد": {
        "سكن عادي": {
          مرفوض: 10,
          "تحت الاستعراض": 20,
          "في انتظار التنسيق": 30,
          "في انتظار السكن": 40,
        },
        "سكن مميز (ذكور)": {
          مرفوض: 6,
          "تحت الاستعراض": 12,
          "في انتظار التنسيق": 18,
          "في انتظار السكن": 24,
        },
        "سكن مميز (إناث)": {
          مرفوض: 4,
          "تحت الاستعراض": 8,
          "في انتظار التنسيق": 12,
          "في انتظار السكن": 16,
        },
      },
      "جدد و مصري": {
      ...
      <div style={{ marginBottom: "20px" }}>
        <label style={{ marginRight: "10px" }}>
          <input
            type="checkbox"
            value="وافد و قدامى"
            checked={selectedHousingTypes.includes("وافد و قدامى")}
            onChange={() => handleCheckboxChange("وافد و قدامى")}
          />{" "}
          وافد و قدامى
        </label>
        <label style={{ marginRight: "10px" }}>
          <input
            type="checkbox"
            value="وافد و جدد"
            checked={selectedHousingTypes.includes("وافد و جدد")}
            onChange={() => handleCheckboxChange("وافد و جدد")}
          />{" "}
          وافد و جدد
        </label>
        <label style={{ marginRight: "10px" }}>
          <input
            type="checkbox"
            value="جدد و مصري"
            checked={selectedHousingTypes.includes("جدد و مصري")}
            onChange={() => handleCheckboxChange("جدد و مصري")}
          />{" "}
          جدد و مصري
        </label>
        <label style={{ marginRight: "10px" }}>
          <input
            type="checkbox"
            value="مصري و قدامى"
            checked={selectedHousingTypes.includes("مصري و قدامى")}
            onChange={() => handleCheckboxChange("مصري و قدامى")}
          />{" "}
          مصري و قدامى
        </label>
      </div>
  ...
  function handleCheckboxChange(type) {
    if (selectedHousingTypes.includes(type)) {
      setSelectedHousingTypes(
        selectedHousingTypes.filter((housingType) => housingType !== type)
      );
    } else {
