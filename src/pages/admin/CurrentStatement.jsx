      ...
      <div className=" flex-1">
        ...
        <form className=" mr-6">
          <div className=" m-4 flex justify-between">
            <button className="w-40 h-10 bg-slate-400 rounded-md hover:opacity-70 transition-all duration-200  hover:bg-slate-600 text-white font-bold py-2 px-4 border-b-4 border-slate-700 hover:border-slate-500 rounded">
              توقيعات التقرير
            </button>

            <button className="w-40 h-10 bg-orange-600 rounded-md hover:opacity-70 transition-all duration-200  hover:bg-orange-400 text-white font-bold py-2 px-4 border-b-4 border-orange-700 hover:border-orange-500 rounded ">
              طباعه التقرير
            </button>
          </div>
          <div>
          ...
          <div className="flex items-center justify-center">
            <div className="bg-mainBlue	 mx-4 h-10 text-fuchsia-50 text-center text-2xl mt-4 rounded-lg text-mr-1 w-1/5">
              الرسوم التى يجب دفعها عن شهر <span></span>
            </div>
          </div>
        </form>
      </div>
