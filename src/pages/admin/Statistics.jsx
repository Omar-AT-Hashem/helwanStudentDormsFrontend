    ...
    <div className="pt-20">
      ...
      <div className="flex gap-10 m-20">
        {statistics.map((statistic) => (
          <div key={`${statistic.title}-statistics`} className="border-mainBlue border-2 w-[600px]  flex flex-col">
            <span className="text-4xl   text-white font-bold bg-mainBlue w-full h-12  flex justify-center items-center">{statistic.title}</span>
