            ...
            return (
              <div className="box" key={record.id}>
                <form className="flex flex-col  py-2 2xl:text-3xl text-2xl	pr-8	">
                  ...
                  <label className="mb-4">
                    {" "}
                    النوع :<strong>{record.النوع}</strong>
                  </label>

                  <div className="mb-4">
                    <label className=" ml-10">
                      {" "}
                      من تاريخ : <strong>{record["من تاريخ "]}</strong>
                    </label>
                    <label className=" mr-10">
                      {" "}
                      الحصول على وجبه :<strong>{record["الحصول وجبه"]}</strong>
                    </label>
                  </div>
                  ...
                  <div className="mb-2">
                    <label className="ml-10">
                      {" "}
                      الى تاريخ : <strong>{record["الى تاريخ"]}</strong>
                    </label>
                    <label className="mr-9">
                      الحصول على وجبه:
                      <strong>{record["الحصول على وجبه"]}</strong>
                    </label>
                  </div>

                  <label className="mb-2">
                    تاريخ السداد :<strong>{record["تاريخ  السداد"]}</strong>
                  </label>

                  <label className="mb-2">
                    {" "}
                    رقم قيمه السداد :
                    <strong>{record["رقم قسيمه السداد"]}</strong>
                  </label>
                  ...
                  <label className="mb-2">
                    {" "}
                    ملاحظات :<strong>{record.ملاحظات}</strong>
                  </label>
                  <label></label>

                  <div className="flex justify-center">
                    <button className="bg-blue-500 hover:opacity-70 hover:cursor-pointer transition-all duration-200  text-white font-bold py-2 px-4 rounded mx-2">
                      تعديل
                    </button>
                    <button className="bg-orange-500 hover:opacity-70 hover:cursor-pointer transition-all duration-200 text-white font-bold py-2 px-4 rounded mx-2">
                      اغلاق
                    </button>
                    <button className="bg-red-500 hover:opacity-70 hover:cursor-pointer transition-all duration-200 text-white font-bold py-2 px-4 rounded mx-2">
                      حذف
                    </button>
                  </div>
                </form>
