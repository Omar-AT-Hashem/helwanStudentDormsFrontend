...
export const AdminSystemSlider = ({ setAdminSliderOpen }) => {
          ...
          <nav className="-mx-3 space-y-6 ">
            ...
            <div className="space-y-3 ">
              ...
              >
                ...
                <span className="mx-2 text-sm font-medium">موارد التسكين </span>
              </Link>
            </div>
            ...
            <div className="space-y-3 ">
              ...
              >
                ...
                <span className="mx-2 text-sm font-medium"> التنسيق</span>
              </Link>
            </div>
            ...
            <div className="space-y-3 ">
              ...
              >
                ...
                <span className="mx-2 text-sm font-medium"> التقارير</span>
              </Link>
              ...
              >
                ...
                <span className="mx-2 text-sm font-medium"> سجل النظام</span>
              </Link>
            </div>
          </nav>
        </div>
